    ...
    with open('YoutubeALL.txt') as f:
        ...
        for line in lines:
            ...
            try:
                ...
                playlistInfo = f"#EXTINF:-1 tvg-chno=\"{channel_no}\" tvg-id=\"{line}\" tvg-name=\"{channel_name}\" tvg-logo=\"{channel.get('image')}\" group-title=\"ARGENTINA\",{channel.get('title')} - {channel.get('description')} - {channel_name}\n"
